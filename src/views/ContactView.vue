<template>
  <section id="hehe">
    <div class="row">
        <div class="col-md-4">
            <div class="theMap">
                <img  :src="thePinUrl" alt="mee" class="thePin"/>
            </div>
        </div>
        <div class="col-md-4">
            <div class="formcarry-container animate-drop-in">
              <form ref="form" action="https://formcarry.com/s/iwwxEiwV8Lx" method="POST" enctype="multipart/form-data" @submit.prevent="handleSubmit">
                ...
                <div class="formcarry-block">
                  ...
                  <input type="text" v-model="formData.name" name="name" id="fc-generated-1-name" placeholder="Your first and last name" required />
                </div>
                
                <div class="formcarry-block">
                  <label for="fc-generated-1-email">Your Email Address:</label>
                  <input type="email" v-model="formData.email" name="email" id="fc-generated-1-email" placeholder="King@Krazee.com" required />
                </div>
                
                <div class="formcarry-block">
                  <label for="fc-generated-1-message">Your message:</label>
                  <textarea v-model="formData.message" name="message" id="fc-generated-1-message" placeholder="Enter your message..." required></textarea>
                </div>
        ...
        <div class="col-md-3">
            <div class="info">
                ...
                <h2>Email</h2>
                <p>kaydenhendrick04@gmail.com</p>
                <h2>Phone</h2>
                <p>062-161-9892</p>
            </div>
        </div>
  ...
  export default {
    data() {
      return {
        ...
        thePinUrl:"https://github.com/kingkrazee/eccomerce/blob/main/images/locationPin.png?raw=true"
      };
    ...
    methods: {
      handleSubmit() {
        ...
        fetch("https://formcarry.com/s/iwwxEiwV8Lx", {
          method: 'POST',
          body: formData
        })
        .then(response => {
...
.theMap{
        height: 400px;
        width: 400px;
        background-image: url('https://github.com/kingkrazee/eccomerce/blob/main/images/SA-map.png?raw=true');
        object-fit: contain;
    }
.animate-drop-in {
